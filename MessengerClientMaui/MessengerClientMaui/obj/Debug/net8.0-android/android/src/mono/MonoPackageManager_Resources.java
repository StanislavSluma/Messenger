...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MessengerClientMaui.dll" comes first in this list. */
		"MessengerClientMaui.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"MessengerClientMaui.Domain.dll",
		"MessengerServer.Domain.dll",
		"Serializator&&Deserializator.dll",
